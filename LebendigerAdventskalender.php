...
class LebendigerAdventskalender {
    ...
    public function __construct() {
        ...
        wp_register_style('lebendiger_adventskalender_calendar', plugin_dir_path(__FILE__).'/assets/calendar.css');
        wp_register_style('lebendiger_adventskalender_door', plugin_dir_path(__FILE__).'/assets/door.css');
        wp_register_style('lebendiger_adventskalender_reservation', plugin_dir_path(__FILE__).'/assets/reservation.css');

        // register plugin scipts
        wp_register_script('lebendiger_adventskalender_door', plugin_dir_path(__FILE__).'/assets/door.js');
